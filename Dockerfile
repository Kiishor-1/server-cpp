...
# Clone, build, and install MongoDB C driver
# RUN git clone https://github.com/mongodb/mongo-c-driver /tmp/mongo-c-driver && \
...
# # Clone, build, and install MongoDB C++ driver
# RUN git clone https://github.com/mongodb/mongo-cxx-driver /tmp/mongo-cxx-driver && \
