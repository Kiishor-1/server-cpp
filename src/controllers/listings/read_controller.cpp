...
//         // Category filter
//         if (category && std::strlen(category) > 0)
//         {
...
//         try {
//             if (minPrice) {
//                 minPriceValue = std::stoi(minPrice);
//             }
//             if (maxPrice) {
//                 maxPriceValue = std::stoi(maxPrice);
//             }
...
//             std::cerr << "Invalid price value: " << e.what() << std::endl;
//             res.code = 400;
//             res.write("Invalid price value");
//             res.end();
//             return;
//         } catch (const std::out_of_range &e) {
//             std::cerr << "Price value out of range: " << e.what() << std::endl;
//             res.code = 400;
//             res.write("Price value out of range");
//             res.end();
//             return;
//         }
...
//         // Print the constructed filter for debugging
//         std::cout << "Constructed filter: " << bsoncxx::to_json(filter_doc) << std::endl;

//         // Set up options for the query, including a limit on the number of results
//         mongocxx::options::find options;
//         options.limit(50); // Set a limit to prevent memory issues
...
//         {
//             std::string searchQuery = search;
//             filter_builder << "name" << bsoncxx::builder::stream::open_document
//                            << "$regex" << searchQuery
//                            << "$options" << "i"  // Case-insensitive search
//                            << bsoncxx::builder::stream::close_document;
//             filter_applied = true;
