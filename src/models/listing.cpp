...
//                  double price, const std::string &title, const std::string &description,
//                  const std::string &image_url, const std::string &image_filename,
//                  const Geometry &geometry)
//     : owner(owner), country(country), location(location), price(price),
//       title(title), description(description), reviews({}), // Initialize with empty reviews
...
//         if (category.empty())
//         throw std::invalid_argument("Category cannot be empty"); // Validate category
//     if (image.url.empty())
...
//         json_data["country"].s(),
//         json_data["location"].s(),
//         json_data["price"].d(),
//         json_data["title"].s(),
//         json_data["description"].s(),
//         json_data["image"]["url"].s(),
//         json_data["image"]["filename"].s(),
